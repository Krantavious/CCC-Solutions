/*
	File Name: Change_New.java
	Name: Rich Yang 
	Class: ICS3U1-23
	Date: Mar 3, 2025
	Description: prints minimum coins needed for an amount of dollars
*/	
...
public class Change_New {
    ...
    public static void main(String[] args) {
        ...
        //prompt user for amount of dollars and store the value
        System.out.println("How many dollars?");
        numCents = sc.nextDouble();

        //run recursive function
        GetChange((int)(numCents*100));
